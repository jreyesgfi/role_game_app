  ...
  static ThemeData get theme {
    return ThemeData(
        ...
        floatingActionButtonTheme: FloatingActionButtonThemeData(
          backgroundColor:
              AppColors.primaryColor, // Default: Material's secondary color
          foregroundColor: AppColors.whiteColor, // Default: Text/icon color
          hoverColor:
              AppColors.primaryColor.withOpacity(0.8), // Default hover color
        ...
        filledButtonTheme: FilledButtonThemeData(
          style: ButtonStyle(
            ...
            foregroundColor: WidgetStateProperty.all(
                AppColors.whiteColor), // Default text color
            overlayColor: WidgetStateProperty.all(
                AppColors.primaryColor.withOpacity(0.1)), // Ripple effect
          ),
        ),
